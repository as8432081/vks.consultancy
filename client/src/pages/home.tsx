...
export default function Home() {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Our QuickBooks experts help you streamline your bookkeeping, accounts payable/receivable, payroll, and financial reporting to ensure accuracy and tax readiness. We offer support for both the US and UK markets.",
    },
    {
      icon: <DollarSign className="w-8 h-8" />,
      title: "Xero Accounting", 
      description: "We provide end-to-end Xero services, including setup, data migration, and daily bookkeeping. Our team helps you automate workflows and manage finances for your business in the US and UK.",
    },
  ];
  ...
  //     review: "Had an outstanding experience working with VKS Consultancy to set up my company & Trademark Registration. Even minute details were explained and all aspects provided. Ready to support beyond hours, hat's off guys."
  //   },
  //   {
  //     name: "Prashant Singh",
  ...
  //     review: "Dedicated, supportive and understanding team… What else do we need to get the jobs done? Thanks to VKS Consultancy for helping us. And I hope this will be maintained as you already established a great business relationship."
  //   },
  //   {
  ...
  //     review: "Highly supporting system for new business.. Thank you VKS Consultancy for providing every type of business-related support to new in the field like me… and want to really appreciate the work of Mr Anand."
  //   },
  //   {
  //     name: "Saajib Zaman",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            <div data-testid="footer-brand">
              <div className="text-2xl font-bold mb-4">VKS Consultancy</div>
            ...
            <div data-testid="footer-contact">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-background/80" data-testid="footer-phone">+91-8887710108</span>
                </div>
                <div className="flex items-center space-x-3">
                  <Mail className="w-5 h-5 text-accent" />
                  <span className="text-background/80" data-testid="footer-email">vks.consultancy@yahoo.com</span>
                </div>
          ...
          <div className="border-t border-background/20 mt-12 pt-8 text-center">
            <p className="text-background/80" data-testid="footer-copyright">
              © 2024 VKS Consultancy. All rights reserved. | Privacy Policy | Terms of Service
            </p>
          </div>
        </div>
      </footer>
